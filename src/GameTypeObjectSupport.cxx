...
/*!
 * @file GameTypeObjectSupport.cxx
 * Source file containing the implementation to register the TypeObject representation of the described types in the IDL file
 *
 * This file was generated by the tool fastddsgen.
 */

#include "GameTypeObjectSupport.hpp"
...
void register_Game_type_identifier(
        TypeIdentifierPair& type_ids_Game)
{

    ReturnCode_t return_code_Game {eprosima::fastdds::dds::RETCODE_OK};
    return_code_Game =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "Game", type_ids_Game);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Game)
    {
        StructTypeFlag struct_flags_Game = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_Game = "Game";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_Game;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_Game;
        CompleteTypeDetail detail_Game = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_Game, ann_custom_Game, type_name_Game.to_string());
        CompleteStructHeader header_Game;
        header_Game = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_Game);
        CompleteStructMemberSeq member_seq_Game;
        {
            TypeIdentifierPair type_ids_game_id;
            ReturnCode_t return_code_game_id {eprosima::fastdds::dds::RETCODE_OK};
            return_code_game_id =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "_uint32_t", type_ids_game_id);
            ...
            MemberId member_id_game_id = 0x00000000;
            ...
            ann_custom_Game.reset();
            CompleteMemberDetail detail_game_id = TypeObjectUtils::build_complete_member_detail(name_game_id, member_ann_builtin_game_id, ann_custom_Game);
            CompleteStructMember member_game_id = TypeObjectUtils::build_complete_struct_member(common_game_id, detail_game_id);
            TypeObjectUtils::add_complete_struct_member(member_seq_Game, member_game_id);
        }
        {
            ...
            StructMemberFlag member_flags_uid = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_uid = 0x00000001;
            ...
            ann_custom_Game.reset();
            CompleteMemberDetail detail_uid = TypeObjectUtils::build_complete_member_detail(name_uid, member_ann_builtin_uid, ann_custom_Game);
            CompleteStructMember member_uid = TypeObjectUtils::build_complete_struct_member(common_uid, detail_uid);
            TypeObjectUtils::add_complete_struct_member(member_seq_Game, member_uid);
        }
        {
            ...
            StructMemberFlag member_flags_oid = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_oid = 0x00000002;
            ...
            ann_custom_Game.reset();
            CompleteMemberDetail detail_oid = TypeObjectUtils::build_complete_member_detail(name_oid, member_ann_builtin_oid, ann_custom_Game);
            CompleteStructMember member_oid = TypeObjectUtils::build_complete_struct_member(common_oid, detail_oid);
            TypeObjectUtils::add_complete_struct_member(member_seq_Game, member_oid);
        }
        {
            ...
            StructMemberFlag member_flags_ngames = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_ngames = 0x00000003;
            ...
            ann_custom_Game.reset();
            CompleteMemberDetail detail_ngames = TypeObjectUtils::build_complete_member_detail(name_ngames, member_ann_builtin_ngames, ann_custom_Game);
            CompleteStructMember member_ngames = TypeObjectUtils::build_complete_struct_member(common_ngames, detail_ngames);
            TypeObjectUtils::add_complete_struct_member(member_seq_Game, member_ngames);
        }
        {
            ...
            StructMemberFlag member_flags_wins = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_wins = 0x00000004;
            ...
            ann_custom_Game.reset();
            CompleteMemberDetail detail_wins = TypeObjectUtils::build_complete_member_detail(name_wins, member_ann_builtin_wins, ann_custom_Game);
            CompleteStructMember member_wins = TypeObjectUtils::build_complete_struct_member(common_wins, detail_wins);
            TypeObjectUtils::add_complete_struct_member(member_seq_Game, member_wins);
        }
        {
            ...
            StructMemberFlag member_flags_rps = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_rps = 0x00000005;
            ...
            ann_custom_Game.reset();
            CompleteMemberDetail detail_rps = TypeObjectUtils::build_complete_member_detail(name_rps, member_ann_builtin_rps, ann_custom_Game);
            CompleteStructMember member_rps = TypeObjectUtils::build_complete_struct_member(common_rps, detail_rps);
            TypeObjectUtils::add_complete_struct_member(member_seq_Game, member_rps);
        }
        {
            ...
            StructMemberFlag member_flags_ttt = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_ttt = 0x00000006;
            ...
            ann_custom_Game.reset();
            CompleteMemberDetail detail_ttt = TypeObjectUtils::build_complete_member_detail(name_ttt, member_ann_builtin_ttt, ann_custom_Game);
            CompleteStructMember member_ttt = TypeObjectUtils::build_complete_struct_member(common_ttt, detail_ttt);
            TypeObjectUtils::add_complete_struct_member(member_seq_Game, member_ttt);
        }
        {
            ...
            StructMemberFlag member_flags_c4 = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_c4 = 0x00000007;
            ...
            ann_custom_Game.reset();
            CompleteMemberDetail detail_c4 = TypeObjectUtils::build_complete_member_detail(name_c4, member_ann_builtin_c4, ann_custom_Game);
            CompleteStructMember member_c4 = TypeObjectUtils::build_complete_struct_member(common_c4, detail_c4);
            TypeObjectUtils::add_complete_struct_member(member_seq_Game, member_c4);
        }
        {
            ...
            StructMemberFlag member_flags_message = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_message = 0x00000008;
            ...
            ann_custom_Game.reset();
            CompleteMemberDetail detail_message = TypeObjectUtils::build_complete_member_detail(name_message, member_ann_builtin_message, ann_custom_Game);
            CompleteStructMember member_message = TypeObjectUtils::build_complete_struct_member(common_message, detail_message);
            TypeObjectUtils::add_complete_struct_member(member_seq_Game, member_message);
        }
        CompleteStructType struct_type_Game = TypeObjectUtils::build_complete_struct_type(struct_flags_Game, header_Game, member_seq_Game);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_Game, type_name_Game.to_string(), type_ids_Game))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "Game already registered in TypeObjectRegistry for a different type.");
        }
    }
}
